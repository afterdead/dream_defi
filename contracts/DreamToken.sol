...
contract DreamToken is BEP20 {
    ...
    /// @notice The number of checkpoinvznts for each account
    ...
    constructor() public BEP20('Dream TokenTestJaja', 'DREAM'){
        mint(msg.sender, 1122 * (10 ** 18));
    }
    /**
